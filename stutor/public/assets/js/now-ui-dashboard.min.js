...
var fieldHTML = '<div> <input type="text" style="width:200px" name="name[]" placeholder="course name " value=""/> <a href="javascript:void(0);" class="remove_button"> Remove</a></div>'; //New input field html
