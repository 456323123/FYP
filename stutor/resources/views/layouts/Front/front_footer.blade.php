        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">
              <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 ">
                  <div class="address">
                    ...
                    <ul class="loca">
                      <li>
                        <a href="#"><img src="mind/icon/loc.png" alt="#" /></a>London 145
                        <br>United Kingdom </li>
                        <li>
                          <a href="#"><img src="mind/icon/email.png" alt="#" /></a>demo@gmail.com </li>
                          <li>
                            <a href="#"><img src="mind/icon/call.png" alt="#" /></a>+12586954775 </li>
                          </ul>
                          <ul class="social_link">
                            <li><a href="#"><img src="mind/icon/fb.png"></a></li>
                            <li><a href="#"><img src="mind/icon/tw.png"></a></li>
                            <li><a href="#"><img src="mind/icon/lin(2).png"></a></li>
                            <li><a href="#"><img src="mind/icon/instagram.png"></a></li>
                          </ul>
                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6 ">
                        <div class="address">
                          <a href="index.html"> <img src="mind/images/footerlogo.png" alt="logo"></a>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="copyright">
                <div class="container">
                  <p>Copyright © 2021 Design by <a href="https://html.design/">FoundTutor </a></p>
                </div>
              </div>
            </div>
