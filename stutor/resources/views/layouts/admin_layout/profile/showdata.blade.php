...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
    ...
    <div class="row  justify-content-center ml-lg-5 pl-lg-5" style="margin-top:90px">
      <div class="col-md-8">
          <section style="margin-top: -23px; height:100px;" >
...
<section class="search-sec" style="margin-top:80px">
    <div class="container">
             ...
             <form action="{{ route('search-data-new') }}"  method="post" novalidate="novalidate">
        {{ csrf_field() }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-5 col-md-3 col-sm-12 p-0">
                            <input id="autocomplete" type="text" autofocus style="border-radius:  0px;" name="searchname" class="form-control search-slt" placeholder="Enter address by google...">

                        </div>
                        <div class="col-lg-4 col-md-3 input-group col-sm-12 p-0">
                            <select style="border-radius:  0px;" class="form-control search-slt" name="searchphone" required autocomplete="searchphone" autofocus >
...
<option value="Parachinar">Parachinar</option>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0" >
                            <button  type="submit" class=" button button3 wrn-btn">Search</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <span aria-hidden="true">&times;</span>
      ...
      <div class="input-group float-right">
          <input type="text"  name="searchname" placeholder="Serach by name and phone number..." class="form-control" >
           <input type="text"  name="searchphone" placeholder="Serach by name and phone number..." class="form-control" >
          <span class="input-group-prepend" class="float-right">
              <button type="submit" class="ml-1  button button2" >search</button>
          </span>
      </div>
      </form>
              ...
              @if($todo->status==1)
                   <li class="list-group-item   " style='font-size:15px; border-radius:0px' >
                    <img src="/uploads/avatars/{{ $todo->avatar }}" style="width:100px; height:100px;  float:left; border-radius:50%; margin-right:25px; margin-bottom:20px;">
