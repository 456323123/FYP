...
@endif
                <h3 class="card-title">Show Send Messages</h3>
{{--  <a href="{{ url('add/new/subject') }}" class="button button2 float-right" style="width: 150px; display:inline-block">Patient Appointments</a>  --}}
  ...
  @foreach($Appointment as $Appointment)
                ...
                $Patient_phone=User::getphone($Appointment->receiver_id);
                $Patient_city=User::getcity($Appointment->receiver_id);
                   $Patient_time=User::getcity($Appointment->receiver_id);
                  ?>
                  <tr>
