...
<section class="search-sec" style="margin-top:80px">
    <div class="container">
             ...
             <form action="{{ url('student/show-teachers') }}"  method="post" novalidate="novalidate">
        {{ csrf_field() }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-5 col-md-3 col-sm-12 p-0">
                            <input  type="text" autofocus style="border-radius:  0px;" name="searchname" class="form-control search-slt" placeholder="Enter address ...">
