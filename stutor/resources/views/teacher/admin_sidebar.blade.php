            ...
            <ul class="nav nav-treeview">
                          @if (Session::get('page')=="profile" )
                            <?php $active ="active"; ?>
                             ...
                             @endif
              <li class="nav-item">
                <a href="{{ url('student/profile') }}" class="nav-link {{ $active }}">
              ...
              <li class="nav-item">
                ...
                <a href="{{ url('password/chanage') }}" class="nav-link {{ $active }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Password Update</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
                          @if (Session::get('page')=="response" )
                            <?php $active ="active"; ?>
                             ...
                             @endif
              <li class="nav-item">
                <a href="{{ url('student/response') }}" class="nav-link {{ $active }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Response</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                ...
                <a href="{{ url('student/message') }}" class="nav-link {{ $active }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Message</p>
                </a>
              </li>
